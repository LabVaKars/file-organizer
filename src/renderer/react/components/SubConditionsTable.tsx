...
export default function SubConditionsTable(props: any) {
            ...
            Cell: ({value, row}:any) => {
              ...
              <>
                <div className="d-flex justify-content-around">
                  {/* <Link to={editUrl}> */}
                    <Button type="button" form={formName} variant="secondary" onClick={() => editSubCondition(handleSubmit, conditionId, value, row.values.type)}>
                      Edit
                    </Button>
                  {/* </Link> */}
                  <Button variant="danger" onClick={() => {
                    deleteCondition({id:value})
